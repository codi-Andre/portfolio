...
<section id="projects" class="mt-20 xl:mt-40">
  <h2 class="text-2xl font-semibold lg:text-3xl xl:text-4xl">Projetos</h2>
  <p class="mt-6 max-w-[70ch] text-base lg:text-lg xl:text-xl">
